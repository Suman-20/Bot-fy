...
const Bot = () => {
  ...
  return (
     <div className='flex flex-col min-h-screen bg-[#0b0d28] text-white'>
         {/* Navbar & Header */}
      <header className="fixed top-0 left-0 w-full border-b border-gray-800 bg-[#0d0d0d] z-10">
        <div className=" container mx-auto flex justify-between items-center px-6 py-4">
          <h1 className="text-lg font-bold">Bot-fy</h1>
        ...
        <div className="w-full max-w-4xl mx-auto px-4 flex flex-col space-y-3">
          {messages.length === 0 ? (
            ...
            <div className="text-center text-gray-400 text-lg">
              👋 Hi, I'm{" "}
              <span className="text-green-500 font-semibold">Bot-fy</span>.
            </div>
          ) : (
          ...
          <div className="w-full flex bg-gray-900 rounded-full px-4 py-2 shadow-lg">
            ...
            <button
             onClick={handleSendMessage}
              className="bg-green-600 hover:bg-green-700 px-4 py-1 rounded-full text-white font-medium transition-colors cursor-pointer"
            >
              Send
            </button>
          </div>
